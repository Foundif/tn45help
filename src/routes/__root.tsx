...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Exodus Mobility Co provides reliable travel and assistance services across Tamil Nadu, focusing on elderly, medical, and station support." },
      { name: "author", content: "Exodus Mobility Co" },
      { property: "og:title", content: "Exodus Mobility Co — Trichy Travel Assistance" },
      { property: "og:description", content: "Reliable travel and assistance services across Tamil Nadu." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Exodus Mobility Co" },
